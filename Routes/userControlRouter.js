...
const { checkParamId, checkUserAccessForDelete, emailExistCheck, checkIsNotHimSelf, accountVerifiedCheck } = require('../Middlewares/checks')
const {
...
router.get('/all/:userId', checkIsNotHimSelf, checkParamId, catchErrors(getUserById))
