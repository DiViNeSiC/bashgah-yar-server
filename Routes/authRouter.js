...
router.post('/active-email', auth, emailExistCheck, accountNotVerifiedCheck, catchErrors(sendAccountActivationEmail))
...
router.put('/active-email/:accountActivationToken', auth, accountNotVerifiedCheck, catchErrors(activeAccount))
